...
# functions.savePlot(opt, valAccHist, lossHist, saveDirPath, netName='SubnetX')
# functions.savetxt(saveDirPath, 'SubnetX', valAccHist, lossHist)

##################### SubnetY ##################################
# opt.num_epochs = opt.num_epochs + 200
...
saveDirPath = os.path.join(opt.PATH, 'Subnets', scenarios, ModelDirName, 'SubnetY')
if not os.path.exists(saveDirPath):
    os.makedirs(saveDirPath)
savePath = os.path.join(saveDirPath, ModelName)
...
functions.savePlot(opt, valAccHist, lossHist, saveDirPath, netName='SubnetY', epochs=opt.num_epochs + 200)
# functions.savetxt(saveDirPath, 'SubnetY', valAccHist, lossHist)
...
# saveDirPath = os.path.join(opt.PATH, 'Subnets', scenarios, 'SubnetZ', ModelDirName)
# if not os.path.exists(saveDirPath):
#     os.makedirs(saveDirPath)
# savePath = os.path.join(saveDirPath, ModelName)
# torch.save(SubnetZModel, savePath)

# functions.savePlot(opt, valAccHist, lossHist, saveDirPath, netName='SubnetZ')
